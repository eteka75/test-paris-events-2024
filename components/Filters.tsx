    ...
    <div>
      <form onSubmit={handleSearch} className="mx-auto mb-2">
        ...
        <div className="relative flex ">
          ...
          <button
            type="submit"
            className="text-white shadow-none min-h-6 flex items-center h-12 whitespace-nowrap absolute end-[3px] bottom-[3px] border-0 cursor-pointer bg-blue-600 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
